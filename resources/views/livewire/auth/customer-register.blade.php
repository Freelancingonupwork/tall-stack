    ...
    <div class="max-w-md w-full space-y-8 ">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600 ">
                Or
                <a href="{{ route('customer.login') }}" class="signin-text font-medium text-indigo-600 hover:text-indigo-500">
        ...
        <form wire:submit="register" class="mt-8 space-y-6">
            <div class="register-form rounded-md shadow-sm -space-y-px">
                <div>
